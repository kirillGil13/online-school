  ...
  <el-container class="box-container course-lessons-block">
    <div class="lesson-container">
      <ul class="lesson-list">
        <li :class="['lesson', lesson.type() === lessonType.IN_PROGRESS ? 'lesson-current' : '', lesson.type() === lessonType.LOCKED ? 'lesson-locked' : '']"
            v-for="(lesson, index) in course.lessons" :key="index" @click="$emit('moveToLesson', lesson.id)">
