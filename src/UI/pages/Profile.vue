    ...
    <el-col :span="24" class="profile__main-content">
      <el-row>
        <el-col :span="windowSize.x > windowWideBreak ? 3 : 24">
          <div
              :class="{'profile__info-full-size': windowSize.x > windowWideBreak,'profile__info-low-size': windowSize.x < windowWideBreak,}"
          >
            <avatar
            ...
            <el-row>
              <el-col :span="24" class="profile__col">
                ...
                >
                  ...
                  <el-tab-pane
                      label="Контактные данные" name="contactData">
